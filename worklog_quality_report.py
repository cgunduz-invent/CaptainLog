...
PEOPLE_RAW: str = """
Aret Cilingir <aret.cilingir@inventanalytics.com>,
Artun Sarıoğlu <artun.sarioglu@invent.ai>,
Asena Ayyıldız <asena.ayyildiz@inventanalytics.com>,
Ayşegül Arabacı <aysegul.arabaci@inventanalytics.com>,
Bahar Şahin <bahar.sahin@inventanalytics.com>,
Bekir Seçmen <bekir.secmen@inventanalytics.com>,
Burcu Barın <burcu.barin@inventanalytics.com>,
Cansel Memişoğlu <cansel.kaya@inventanalytics.com>,
Deniz Nil Cengiz <deniz.cengiz@inventanalytics.com>,
Didem Paloğlu <didem.paloglu@inventanalytics.com>,
Doğukan Durukan <dogukan.durukan@inventanalytics.com>,
Ece Yurtsever <ece.yurtsever@inventanalytics.com>,
Ecem Sert <ecem.sert@inventanalytics.com>,
Ekinsu Çiçek <ekinsu.cicek@inventanalytics.com>,
Emre Gezer <emre.gezer@inventanalytics.com>,
Furkan Oğuz Gümüş <furkan.gumus@inventanalytics.com>,
Gözde Gözütok <gozde.gozutok@inventanalytics.com>,
Hümeyra Arslan <humeyra.arslan@inventanalytics.com>,
Kübra Gülcan <kubra.gulcan@inventanalytics.com>,
Leyli Jafarova <leyli.jafarova@inventanalytics.com>,
Melike Şahin <melike.sahin@invent.ai>,
Memduh Yusuf Duranlı <memduh.duranli@inventanalytics.com>,
Mert Altıntaş <mert.altintas@inventanalytics.com>,
Müge Önder <muge.onder@inventanalytics.com>,
Müzeyyen Yakan <muzeyyen.yakan@inventanalytics.com>,
Neslihan Tanyeri <neslihan.tanyeri@inventanalytics.com>,
Rana Kaya <rana.kaya@inventanalytics.com>,
Selin Abatay <selin.abatay@invent.ai>,
Serap Seyrek <serap.seyrek@inventanalytics.com>,
Serhat Evrenosoglu <serhat.evrenosoglu@invent.ai>,
Sümeyra Demir <sumeyra.demir@inventanalytics.com>,
Yiğitcan Aksoy <yigitcan.aksoy@inventanalytics.com>
"""
